...
class Github
{
    ...
    {
        $apiData = file_get_contents($url, null, stream_context_create(self::$streamOptions));
        if ($apiData) {
    ...
    {
        file_put_contents($path, file_get_contents($url, null, stream_context_create(self::$streamOptions)));
    }
}
